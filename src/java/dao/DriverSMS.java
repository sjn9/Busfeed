...
public class DriverSMS {
  ...
  public static void main(String DriverMobile , String Name, String Bus, String Route ) throws UnsupportedEncodingException {
  String message = new String(("Route : " + Route + ". Bus Number : " + Bus ).getBytes("UTF8"));
  ...
  String numbers = "&numbers=" + ("91"+DriverMobile);
