...
public class SMS {
  ...
  public static void main(String Password , String Mobile) throws UnsupportedEncodingException {
  String message = new String(("Your password is : "+Password).getBytes("UTF8"));
